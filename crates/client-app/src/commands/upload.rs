...
use crate::commands::connection::{open_conn, server_of};
...
use crate::dto::{StageUploadRequest, UploadKind, UploadPreview};
use crate::error::UiError;
use crate::jobs::{StagedUpload, UploadJobs};
use crate::upload::{prepare_blog_streams, prepare_image_streams, total_chunks};
...
pub async fn stage_upload(
    ...
    let _ = &connect_lock; // open_conn is used directly here (unauth directory GETs)
